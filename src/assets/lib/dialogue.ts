...
export const result = (args: Arguments): string[] => {
  return [
    ...
    ' ',
    '| id | hash   | date           | title                                                               |',
    "| 12 | 0x1234 | April 14, 2022 | Our Apollo Mission: Let's Go to the Moon and Earn Up to 5,000 USDT! |",
    '| 16 | 0x2134 | April 14, 2022 | 2022-4-14SEOR Moonbeam                                              |',
    '| 20 | 0x1134 | April 14, 2022 | Blockchain: A decentralized postmodernist philosophical discourse   |',
    ' ',
